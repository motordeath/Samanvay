...
import { getTransfersController, getTransferController, completeTransferController, cancelTransferController, startTransferController } from '../controllers/transfer.controller';
...
router.post('/:id/start', authenticate, requireTransferOwnership(), startTransferController);
