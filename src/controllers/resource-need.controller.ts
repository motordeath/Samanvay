...
export async function createResourceNeedController(req: Request, res: Response, next: NextFunction) {
  try {
...
export async function cancelResourceNeedController(req: Request, res: Response, next: NextFunction) {
  try {
    const { id } = req.params;
